...
//    public final static String FILE_UPLOAD_DIC = "\\var\\www\\mall\\upload";
    public final static String FILE_UPLOAD_DIC = "/var/www/mall/upload/";

    public final static int INDEX_CAROUSEL_NUMBER = 10;//首页轮播图数量(可根据自身需求修改)

    public final static int INDEX_CATEGORY_NUMBER = 100;//首页一级分类的最大数量

    public final static int INDEX_GOODS_HOT_NUMBER = 10;//首页热卖商品数量
    public final static int INDEX_GOODS_NEW_NUMBER = 10;//首页新品数量
