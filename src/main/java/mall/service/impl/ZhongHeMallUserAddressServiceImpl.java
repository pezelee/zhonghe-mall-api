...
import mall.dao.MallUserAddressMapper;
...
@Service
public class ZhongHeMallUserAddressServiceImpl implements ZhongHeMallUserAddressService {

    @Autowired
    private MallUserAddressMapper userAddressMapper;

    @Override
    public List<ZhongHeMallUserAddressVO> getMyAddresses(Long userId) {
        List<MallUserAddress> myAddressList = userAddressMapper.findMyAddressList(userId);
        List<ZhongHeMallUserAddressVO> zhongHeMallUserAddressVOS = BeanUtil.copyList(myAddressList, ZhongHeMallUserAddressVO.class);
        return zhongHeMallUserAddressVOS;
    }
